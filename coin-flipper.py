#Robert's Coin Flipper
"""
Below is my program that will ask the user how many times they would like to flip the coin.
It uses that to flip the coin x number of times and then print out how many heads,
tails, and the percentage of each.
"""
